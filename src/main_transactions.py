...
print(currency_conversion(transaction_usd))  # Сумма в рублях конвертированная из USD
print(currency_conversion(transaction_eur))  # Сумма в рублях конвертированная из EUR
print(currency_conversion(transaction_rub))  # Сумма в рублях
