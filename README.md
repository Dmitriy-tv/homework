...
начало и конец функций. Добавлен файл utils.py,
где создана функция, которая читает JSON-файл и
возвращает список словарей с данными о финансовых
транзакциях. Созданы функции считывания финансовых
операций из CSV и Excel;
...
2. Добавлены логи для функций data_transactions, transaction_amount в модуле utils;
