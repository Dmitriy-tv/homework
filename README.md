# Приложение банковских операций клиента

## Описание: Приложение разработаное на языке python для банковских операций клиента.
...
10. Реализована функция для поиска в списке словарей операций по указанной строке в файле line_search.py;
11. Реализована функция для подсчета количества банковских операций в файле transaction_counter.py;
